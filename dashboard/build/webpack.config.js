...
webpackConfig.output = {
  filename: `assets/js/[name].[${config.compiler_hash_type}].js`,
...
webpackConfig.module.loaders.push(
  ...
  { test: /\.(png|jpg|gif)$/,    loader: 'url?name=assets/img/[name].[hash:7].[ext]&limit=8192' }
)
/* eslint-enable */
...
if (!__DEV__) {
  ...
  webpackConfig.plugins.push(
    new ExtractTextPlugin('assets/css/[contenthash].css', {
      allChunks: true
    })
  )
}
